// Package flymachinesclient provides primitives to interact with the openapi HTTP API.
//
...
// ApiDNSConfig defines model for api.DNSConfig.
type ApiDNSConfig struct {
	SkipRegistration *bool `json:"skip_registration,omitempty"`
}

// ApiFile defines model for api.File.
type ApiFile struct {
	...
	// RawValue RawValue containts the base64 encoded string of the file contents.
	RawValue *string `json:"raw_value,omitempty"`

	// SecretName SecretName is the name of the secret that contains the base64 encoded file contents.
	SecretName *string `json:"secret_name,omitempty"`
}

// ApiHTTPOptions defines model for api.HTTPOptions.
...
// ApiHTTPResponseOptions defines model for api.HTTPResponseOptions.
type ApiHTTPResponseOptions struct {
	Headers *map[string]map[string]interface{} `json:"headers,omitempty"`
}

// ApiMachineCheck defines model for api.MachineCheck.
...
// ApiMachineConfig defines model for api.MachineConfig.
...
// ApiMachineGuest defines model for api.MachineGuest.
...
// ApiMachineHTTPHeader defines model for api.MachineHTTPHeader.
type ApiMachineHTTPHeader struct {
	Name   *string   `json:"name,omitempty"`
	Values *[]string `json:"values,omitempty"`
}

// ApiMachineInit defines model for api.MachineInit.
...
// ApiMachineMetrics defines model for api.MachineMetrics.
type ApiMachineMetrics struct {
	Path *string `json:"path,omitempty"`
	Port *int    `json:"port,omitempty"`
}

// ApiMachineMount defines model for api.MachineMount.
...
// ApiMachinePort defines model for api.MachinePort.
...
// ApiMachineProcess defines model for api.MachineProcess.
...
// ApiMachineRestart defines model for api.MachineRestart.
type ApiMachineRestart struct {
	// MaxRetries MaxRetries is only relevant with the on-failure policy.
	MaxRetries *int    `json:"max_retries,omitempty"`
	Policy     *string `json:"policy,omitempty"`
}

// ApiMachineService defines model for api.MachineService.
...
// ApiMachineServiceConcurrency defines model for api.MachineServiceConcurrency.
...
// ApiProxyProtoOptions defines model for api.ProxyProtoOptions.
type ApiProxyProtoOptions struct {
	Version *string `json:"version,omitempty"`
}

// ApiStatic defines model for api.Static.
type ApiStatic struct {
	GuestPath string `json:"guest_path"`
	UrlPrefix string `json:"url_prefix"`
}

// ApiStopConfig defines model for api.StopConfig.
type ApiStopConfig struct {
	Signal  *string `json:"signal,omitempty"`
	Timeout *string `json:"timeout,omitempty"`
}

// ApiTLSOptions defines model for api.TLSOptions.
...
type ClientInterface interface {
	...
	MachinesDelete(ctx context.Context, appName string, machineId string, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	MachinesReleaseLease(ctx context.Context, appName string, machineId string, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	MachinesCreateLeaseWithBody(ctx context.Context, appName string, machineId string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	MachinesCreateLease(ctx context.Context, appName string, machineId string, body MachinesCreateLeaseJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// VolumesGetSnapshots request
	VolumesGetSnapshots(ctx context.Context, appName string, volumeId string, reqEditors ...RequestEditorFn) (*http.Response, error)
}
...
func (c *Client) MachinesDelete(ctx context.Context, appName string, machineId string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewMachinesDeleteRequest(c.Server, appName, machineId)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) MachinesReleaseLease(ctx context.Context, appName string, machineId string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewMachinesReleaseLeaseRequest(c.Server, appName, machineId)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) MachinesCreateLeaseWithBody(ctx context.Context, appName string, machineId string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewMachinesCreateLeaseRequestWithBody(c.Server, appName, machineId, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) MachinesCreateLease(ctx context.Context, appName string, machineId string, body MachinesCreateLeaseJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewMachinesCreateLeaseRequest(c.Server, appName, machineId, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) VolumesGetSnapshots(ctx context.Context, appName string, volumeId string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewVolumesGetSnapshotsRequest(c.Server, appName, volumeId)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewMachinesDeleteRequest(server string, appName string, machineId string) (*http.Request, error) {
	var err error
...
func NewMachinesReleaseLeaseRequest(server string, appName string, machineId string) (*http.Request, error) {
	var err error
...
func NewMachinesCreateLeaseRequest(server string, appName string, machineId string, body MachinesCreateLeaseJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewMachinesCreateLeaseRequestWithBody(server, appName, machineId, "application/json", bodyReader)
}

// NewMachinesCreateLeaseRequestWithBody generates requests for MachinesCreateLease with any type of body
func NewMachinesCreateLeaseRequestWithBody(server string, appName string, machineId string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
// NewVolumesGetSnapshotsRequest generates requests for VolumesGetSnapshots
func NewVolumesGetSnapshotsRequest(server string, appName string, volumeId string) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	MachinesDeleteWithResponse(ctx context.Context, appName string, machineId string, reqEditors ...RequestEditorFn) (*MachinesDeleteResponse, error)
	...
	MachinesReleaseLeaseWithResponse(ctx context.Context, appName string, machineId string, reqEditors ...RequestEditorFn) (*MachinesReleaseLeaseResponse, error)
	...
	MachinesCreateLeaseWithBodyWithResponse(ctx context.Context, appName string, machineId string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*MachinesCreateLeaseResponse, error)

	MachinesCreateLeaseWithResponse(ctx context.Context, appName string, machineId string, body MachinesCreateLeaseJSONRequestBody, reqEditors ...RequestEditorFn) (*MachinesCreateLeaseResponse, error)
	...
	// VolumesGetSnapshotsWithResponse request
	VolumesGetSnapshotsWithResponse(ctx context.Context, appName string, volumeId string, reqEditors ...RequestEditorFn) (*VolumesGetSnapshotsResponse, error)
}
...
type VolumesGetSnapshotsResponse struct {
	Body         []byte
	HTTPResponse *http.Response
...
// Status returns HTTPResponse.Status
func (r VolumesGetSnapshotsResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r VolumesGetSnapshotsResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
func (c *ClientWithResponses) MachinesDeleteWithResponse(ctx context.Context, appName string, machineId string, reqEditors ...RequestEditorFn) (*MachinesDeleteResponse, error) {
	rsp, err := c.MachinesDelete(ctx, appName, machineId, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) MachinesReleaseLeaseWithResponse(ctx context.Context, appName string, machineId string, reqEditors ...RequestEditorFn) (*MachinesReleaseLeaseResponse, error) {
	rsp, err := c.MachinesReleaseLease(ctx, appName, machineId, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) MachinesCreateLeaseWithBodyWithResponse(ctx context.Context, appName string, machineId string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*MachinesCreateLeaseResponse, error) {
	rsp, err := c.MachinesCreateLeaseWithBody(ctx, appName, machineId, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) MachinesCreateLeaseWithResponse(ctx context.Context, appName string, machineId string, body MachinesCreateLeaseJSONRequestBody, reqEditors ...RequestEditorFn) (*MachinesCreateLeaseResponse, error) {
	rsp, err := c.MachinesCreateLease(ctx, appName, machineId, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseMachinesCreateLeaseResponse(rsp)
...
// VolumesGetSnapshotsWithResponse request returning *VolumesGetSnapshotsResponse
func (c *ClientWithResponses) VolumesGetSnapshotsWithResponse(ctx context.Context, appName string, volumeId string, reqEditors ...RequestEditorFn) (*VolumesGetSnapshotsResponse, error) {
	rsp, err := c.VolumesGetSnapshots(ctx, appName, volumeId, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseVolumesGetSnapshotsResponse(rsp)
}
...
// ParseVolumesGetSnapshotsResponse parses an HTTP response from a VolumesGetSnapshotsWithResponse call
func ParseVolumesGetSnapshotsResponse(rsp *http.Response) (*VolumesGetSnapshotsResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &VolumesGetSnapshotsResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
